...
class App extends Component {
  ...
  // SPOT-CHECK-2: 
  generateCompanyTags = companies => companies.map(company => <Company name={company.name} revenue={company.revenue} key={company.name}/>)
      ...
      <div>
        ...
        <div className="ex-space">
          ...
          <div className="exercise" id="spotcheck-3">
            {companies.map(c => <Company name={this.capitalizeName(c.name)} revenue={c.revenue} key={c.name}/>)}
          </div>
        </div>
        ...
        <div className="ex-space">
          ...
          <div className="exercise" id="spotcheck-6">
            {this.state.companies.map(c => <Company name={this.capitalizeName(c.name)} revenue={c.revenue} key={c.name}/>)}
          </div>
        </div>
